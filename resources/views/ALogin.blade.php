...
width: 40%; margin-left: 33%;">
	 ...
	 <input style="margin-left: 35px;" placeholder="info@agency.az" type="email" name="">
	 <br><br>
...
<p><a style="text-decoration-line: none;" href="{{route('afq')}}"> Hesabın Yoxdur ? Qeydiyyatdan Keç </a></p>
	</fieldset>
<br>
<br>
<br>
...
<footer >&copy FaceAds 2019 <br> 
Bütün Hüquqlar Qorunur </footer>
</html>