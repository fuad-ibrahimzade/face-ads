...
<div class="freelancer"><br>
    <fieldset style=" background-color : white;width: 40%; margin-left: 33%;">
        <form style= "margin-left:25px"; method="post" action="{{url(Auth::user()->email.'/mark/create')}}" enctype="multipart/form-data" class="form" novalidate >
            @csrf
            <h3> Sahibkar  Qeydiyyat </h3>
            ...
            <br>
            <br>
            <input style="margin-left: 45%" type="submit" name="submit" value="Markanı əlavə et" class="submit"> <br>
