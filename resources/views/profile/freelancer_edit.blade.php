...
<h3> Freelancer Qeydiyyatının Yenilənməsi </h3>
  ...
  {{--<img style="margin-left: 25px;" height="55px"; src="{{asset('storage/avatars/'.Auth::user()->profile_image)}}" class="thumb_profile_image"> <br>--}}
 ...
 <br>
  ...
  <span>Xidmətinizin Qiymət Aralığını Seçin</span> <br>
    ...
    {{--<input type="button" name="new_price_remover" value="Seçilmiş Qiymət Aralığını Poz" class="new_price_remover">--}}
