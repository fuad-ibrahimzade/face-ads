...
<fieldset style=" background-color:white ;background-color:#e6e6e6;width: 650px; margin-left: auto;margin-right: auto;border-radius: 10px">
<form style= "margin-left:25px"; method="post" action="{{url('profile/'.Auth::user()->email.'/edit')}}" enctype="multipart/form-data">
    @csrf
<h3 class="text-center"> Agentlik Qeydiyyatının Yenilənməsi </h3>
  ...
  <span>Xidmətinizin Qiymət Aralığını Seçin</span> <br>
    ...
    @if(isset(Auth::user()->pricing2))
            <div class="flex-column pricing_group2">
                <em style="font-style: italic; display: inline-block;">2- </em>&nbsp;&nbsp;
            </div>
    ...
    @if(isset(Auth::user()->pricing3))
        {{--<br>--}}
            <div class="flex-column pricing_group3">
                <em style="font-style: italic; display: inline-block;">3- </em>&nbsp;&nbsp;
            </div>
