...
<div class="freelancer" style="margin-left: 10%"><br>
    ...
    <fieldset style=" background-color:#e6e6e6 ;width: 600px;padding-bottom: 20px;margin-left: auto;margin-right: auto;border-radius: 10px">
        <form style= "margin-left:25px"; method="post" action="{{url(Auth::user()->email.'/smmservice/update',$smmService->id)}}" enctype="multipart/form-data" class="form" novalidate >
            @csrf
            {{--<h3> Yeni Marka Üzrə Iş Qeydiyyatı </h3>--}}
            <h3 class="text-center"> Markaya Düzəliş Et </h3>
            ...
            <input style="margin-left: 25px;" placeholder="" type="tex" name="name" value="{{$smmService->businessMark->name}}">
            <br>
            <br>
            ...
            <img style="margin-left: 25px;" height="55px"; src="{{$smmService->businessMark->profile_image}}" class="thumb_profile_image"> <br>
            ...
            <br>
            <br>
            <textarea style="width: 60%; height: 60px; margin-left: 25px;" placeholder="." name="activity">{{$smmService->businessMark->activity}}</textarea>
            <br> <br>
            ...
            <div style="font-family:Georgia, serif;margin-left: 25px;">
                <div class="sector_parent">
                    ...
                    {{--<div class="isector_parent">--}}
                        ...
                        {{--"margin-left: 69px;--}}
                    {{--</div>--}}
                    @foreach($smmService->businessMark->sector as $sector)
                        <div class="isector_parent">
                ...
                <input style="margin-left: 25px;" placeholder=""  name="work_start" value="{{$smmService->work_start}}" width="276" >
                <br>
                ...
                <br>
                <input style="margin-left: 25px;" placeholder=""  name="work_end" value="{{isset($smmService->work_end)?$smmService->work_end:''}}" width="276" >
                {{--<input id="datepicker" width="276" />--}}
                <br>
                <br>
                <input style="margin-left: 28%" type="submit" name="submit" value="Markaya düzəlişi tamamla" class="submit"> <br>
