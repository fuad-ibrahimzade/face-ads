...
<fieldset style=" background-color:#e6e6e6 ;width: 45%; margin-left: 30%;">
 <form style= "margin-left:25px"; method="post" action="{{route('afq')}}" enctype="multipart/form-data" class="form" novalidate >
     @csrf
  <h3> Agentlik Qeydiyyat </h3>
...
<a style="text-decoration-line: none;" "color:#ff1a1a;"   href="" target="_blank">Şərtlər və Qaydalar</a> <br>
<input style="margin-left: 45%" type="submit" name="submit" value="Qeydiyyat"> <br>
